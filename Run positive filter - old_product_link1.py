...
def save_link(link):
    with open('products.csv', mode='a' , newline='',encoding='utf-8') as csv_details:
...
def get_products(driver,url,delay,filters,filt,our_price,products2):
...
def start():
    ...
    products = read_file(root + '\products.csv')
    filters = filters[1:]
    filt = filt[0:]
    #print(filt)
    get_products(driver,url,delay,filters,filt,price,products)
